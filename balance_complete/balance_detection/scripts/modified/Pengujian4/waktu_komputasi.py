...
for _ in range(50):
    ...
    cpu_usage = psutil.cpu_percent(interval=0.2)  # Mengambil penggunaan CPU dalam persen dengan interval 1 detik
...
with open('/home/robotis/catkin_ws/src/balance_detection/scripts/modified/Pengujian4/datas/idle.csv', 'w') as csvfile:
