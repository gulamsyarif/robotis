...
denoised_df.to_csv(r'C:\Users\syari\Downloads\balance_detection_modified\balance_detection\scripts\UKF_dibeneri\Data\jongkok\oriWT_filtered.csv', index=False)
