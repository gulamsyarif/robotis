...
imu_data = pd.read_csv(r'C:\Users\syari\Downloads\balance_detection_modified\balance_detection\scripts\UKF_dibeneri\Pengujian3\jatuh\raw_imu.csv')
...
denoised_df.to_csv(r'C:\Users\syari\Downloads\balance_detection_modified\balance_detection\scripts\UKF_dibeneri\Pengujian3\jatuh\UKF_filtered.csv', index=False)
