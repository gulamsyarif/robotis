...
fig.suptitle("Comparison of CoM Coordinates Across Position", fontsize=18)

# Define custom titles for each subplot
custom_titles = [
    "Static Squat - CoM, and Support Polygon Area (X-axis)",
...
plt.savefig(r'C:\Users\syari\Downloads\balance_detection_modified\balance_detection\scripts\UKF_dibeneri\Pengujian2\jongkok_comparison.png', dpi=600)
plt.show()
