...
csv_files = [
    r'C:\Users\syari\Downloads\balance_detection_modified\balance_detection\scripts\UKF_dibeneri\Data\jongkok\UKF_complete.csv',
    r'C:\Users\syari\Downloads\balance_detection_modified\balance_detection\scripts\UKF_dibeneri\Data\berdiri_statis\UKF_complete.csv',
    r'C:\Users\syari\Downloads\balance_detection_modified\balance_detection\scripts\UKF_dibeneri\Data\berjalan1\UKF_complete.csv',
    r'C:\Users\syari\Downloads\balance_detection_modified\balance_detection\scripts\UKF_dibeneri\Data\nendang\UKF_complete.csv'
]
...
titles = ["Static Squat - CoM and Support Polygon Projection", "Static Standing - CoM and Support Polygon Projection", "Walking - CoM and Support Polygon Projection", "Kicking - CoM and Support Polygon Projection"]
...
for i, csv_file in enumerate(csv_files):
    ...
    ax.scatter(0, 0, color='indigo', label='Base Point', s=100, zorder=5)
...
plt.tight_layout()
plt.savefig(r'C:\Users\syari\Downloads\balance_detection_modified\balance_detection\scripts\UKF_dibeneri\Pengujian3\jongkok_comparison.png', dpi=600)
plt.show()
