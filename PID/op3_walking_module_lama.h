...
#include "open_cr_module/OrientationRPY.h"
...
class WalkingModule : public robotis_framework::MotionModule, public robotis_framework::Singleton<WalkingModule>
{
 ...
 private:
  ...
  /* Custom Code */
  void sensoryFeedbackOrientation(const double &rollOrientationErr, const double &pitchOrientationErr, double *balance_angle);
  void sensoryFeedbackCombined(const double &rollOrientationErr, const double &pitchOrientationErr, double *balance_angle);
  void coordOffsetFeedback(const double &pitchOrientationErr);
  ...
  double lowPassFilter(double alpha, double x_input, double& x_old);
  ...
  // Custom
  ros::Publisher orientation_pid_pub_;
  ...
  // custom code
  open_cr_module::OrientationRPY orientation_msg_;
  ...
  double pitch_orientation_prev;
  double roll_orientation_prev;
